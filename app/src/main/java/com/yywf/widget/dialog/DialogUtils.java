...
//        customBuilder.setCancelable(false);
    ...
    public static MyCustomDialog showDialogDl(final Context mContext, Spanned title, String leftText, String rightText, String content, View.OnClickListener leftClick, View.OnClickListener rightClick){
        LayoutInflater inflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.alert_dialog, null);
        TextView tv_title = view.findViewById(R.id.tv_alert_dialog_title);
        tv_title.setText(title);
